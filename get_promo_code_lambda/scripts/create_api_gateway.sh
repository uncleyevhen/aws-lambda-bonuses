...
API_NAME="promo-code-api"
FUNCTION_NAME="get-promo-code" # Основна функція, яка викликається
ROUTE_KEY="POST /get-code"
...
log_info "Endpoint URL: ${GREEN}${API_ENDPOINT}/get-code${NC}"
